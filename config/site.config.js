...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'contact@shanejay.onmicrosoft.com',
  ...
  email: 'mailto:contact@shane-jay.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Shane-Jay',
    },
  ],
